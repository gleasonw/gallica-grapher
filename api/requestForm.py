from wtforms import ValidationError, Form, BooleanField, StringField
import re
...
class SearchForm(Form):
	...
	papers = StringField(render_kw={"placeholder": "Leave blank to search all newspapers"})
	searchTerm = StringField(render_kw={"placeholder": "'pomme'"})
	yearRange = StringField("Do you want a year range?", [Regexp(yearsRe,message="Acceptable example ranges: '1870-1890', '1840.1860', '1920,1940'"),
																   validateYearRange], render_kw={"placeholder": "1900-1930"})
	strictYearRange = BooleanField("Restrict search to papers that published continuously over this year range?")
