...
from gallicaGetter.buildqueries.argToQueryTransformations import OccurrenceQueryBuilder
from gallicaGetter.buildqueries.argToQueryTransformations import PaperQueryBuilder
