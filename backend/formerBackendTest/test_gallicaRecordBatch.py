...
class TestRecordBatch(TestCase):
    ...
    def get_request_mock():
        with open(os.path.join(here, 'backend/formerBackendTest/resources/dummyKeywordRecords.xml'), "rb") as f:
...
class TestPaperRecordBatch(TestCase):
    ...
    def test_parse_records_from_xml(self, mock_get):
        with open(os.path.join(here, 'backend/formerBackendTest/resources/dummyNewspaperRecords.xml'), "rb") as f:
