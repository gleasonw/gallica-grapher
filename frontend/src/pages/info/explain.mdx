...
If you have an idea, suggestion, or question about the code, don't hesitate to make a pull request or new issue on Github. The core parsing code is written in Python, the frontend in Typescript and React.
